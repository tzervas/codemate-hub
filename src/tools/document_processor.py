...
class DocumentChunk:
    ...
    def __post_init__(self):
        if not self.chunk_id:
            ...
            self.chunk_id = f"{self.metadata.get('source', 'unknown')}_{self.chunk_index}_{content_hash}"
...
class DocumentProcessor:
    ...
    def _build_metadata(self, path: Path) -> dict:
        ...
        return {
            ...
            "mime_type": self.SUPPORTED_FORMATS.get(path.suffix.lower(), "application/octet-stream"),
