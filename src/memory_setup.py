...
def initialize_memory(
    ...
    db_path = db_path or os.getenv("CHROMA_DB_DIR", DEFAULT_CHROMA_DIR)
    ...
    try:
        ...
        embeddings = OllamaEmbeddings(
            ...
            model=DEFAULT_MODEL,  # Must match default pulled model
        )
        ...
        if verbose:
            print("[memory] ✓ Chroma database initialized successfully")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("[memory] - Database: persistent storage enabled")
